...
switch ($data) {
	...
	case "send_otp":
		...
		require_once __DIR__ . "/auth/send_otp.php";
	...
	case "verify_otp":
		...
		require_once __DIR__ . "/auth/verify_otp.php";

		#endregion verify_otp
		break;


	default:
		error_log("ERROR 2832619488780639113786164052355287971983");
		echo json_encode(false);
		die();
}
